...
<div class="cate_content">
    ...
    <form method="POST" enctype="multipart/form-data" class="cate_info" action="/products/AddProducts/add" onchange="loadFile(event)">
        {{ csrf_field() }}
        <h4 class="cate_lable"> <i class="fas fa-folder-plus"></i> ادخال المنتج</h4>
        <div class="msg2">
            @if (isset($msg2))
        ...
        <div class="row ">
            <div class="col-md-6 cate_info_right">
                ...
                <div class="row ">
                    ...
                    <select  id="pro_status" name="pro_status" class="form-control px-0 text-center" required value="{{old('pro_unit')}}"->
                        <option>متوفر</option>
                    ...
                    <div class="col-md-4">
                        ...
                        <select  id="pro_unit" name="pro_unit" class="form-control px-0 text-center" required value="{{old('pro_unit')}}">
                        <option >كيلو</option>
                        <option >جرام</option>
                        <option >لتر</option>
                    </select>
                    ...
                    <input type="number"  id="pro_weight" name="pro_weight" class="form-control px-0 text-center" required value="{{old('pro_weight')}}"/>
