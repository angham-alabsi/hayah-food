...
<div class="cate_content col-md">
    ...
    <form method="POST" enctype="multipart/form-data" class="cate_info" action="/gallery/updateProductsPhotos/update2?media_id={{$item->media_id}}" onchange="loadFile(event)">
    @endforeach
        {{ csrf_field() }}
