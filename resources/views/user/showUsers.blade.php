...
<section class="cate_show col-md">
    <div class="shadow_content">
        <h5 class="cate_lable" > <i class="fas fa-users"></i> عرض المستخدمين</h5>
        <div class="cate_search">
            <form action="/userSearch/activeUsers" method="POST">
                {{ csrf_field() }}
                {{method_field('GET')}}
                <div class="msg2">
                    @if (isset($msg2))
        ...
        <table class="table table-bordered">
            ...
            <tr>
                    ...
                    <form action="/users/updateUsers/deleted?user_id={{$item->user_id}}" method="POST" class="table_action">
                        {{ csrf_field() }}
                        {{ method_field('GET')}}
